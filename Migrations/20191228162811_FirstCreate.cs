    ...
    public partial class FirstCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdMensagem = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdExericio = table.Column<int>(nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Exercicios", x => x.IdExericio);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(maxLength: 100, nullable: false),
                    Telemovel = table.Column<string>(maxLength: 13, nullable: false),
                    Nacionalidade = table.Column<string>(maxLength: 100, nullable: false),
                    Username = table.Column<string>(maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdSolicitacao = table.Column<string>(nullable: false),
                    NumAdmin = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NumCC = table.Column<string>(maxLength: 8, nullable: false),
                    NumAdmin = table.Column<string>(nullable: true),
                    IdSolicitacao = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumAdmin = table.Column<string>(nullable: true),
                    ValidoDe = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumProfessor = table.Column<string>(nullable: true),
                    NumAdmin = table.Column<string>(nullable: true),
                    ID_Solicitacao = table.Column<string>(nullable: true),
